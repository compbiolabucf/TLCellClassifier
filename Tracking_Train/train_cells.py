...
class Cells(object):
    ...
    def read_train(self):
        filenames, ids, camera_indices = cells.read_train_split_to_str(
            self._dataset_dir)
    ...
    def read_test(self):
        return cells.read_test_split_to_str(self._dataset_dir)


def main():
    arg_parser = train_app.create_default_argument_parser("cells")
    arg_parser.add_argument(
        "--dataset_dir", help="Path to cells dataset directory.",
        default="resources/Market-1501-v15.09.15")
    arg_parser.add_argument(
        "--sdk_dir", help="Path to cells baseline evaluation software.",
        default="resources/Market-1501-v15.09.15-baseline")
    args = arg_parser.parse_args()
    dataset = Cells(args.dataset_dir, num_validation_y=0.1, seed=1234)
    ...
    if args.mode == "train":
        ...
        network_factory = net.create_network_factory(
            is_training=True, num_classes=cells.MAX_LABEL + 1,
        ...
        train_app.train_loop(
            ...
            num_images_per_id=4, image_shape=cells.IMAGE_SHAPE,
            **train_kwargs)
    elif args.mode == "eval":
        ...
        gallery_features = train_app.encode(
            ...
            gallery_filenames, image_shape=cells.IMAGE_SHAPE)
        sio.savemat(
        ...
        #     net.preprocess, network_factory, args.restore_path,
        #     query_filenames, image_shape=cells.IMAGE_SHAPE)
        # sio.savemat(
        ...
        train_app.finalize(
            ...
            image_shape=cells.IMAGE_SHAPE,
            output_filename="./cells.ckpt")
