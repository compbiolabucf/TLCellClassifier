...
class Visualization(object):
    ...
    def draw_trackers(self, tracks, frame_idx):
...
#
        scale = 1
        cv2.putText(self.viewer.image, str(frame_idx), (5 * scale, 10 * scale), cv2.FONT_HERSHEY_SIMPLEX, 0.4 * scale, (0, 255, 255), int(0.5 * scale))
